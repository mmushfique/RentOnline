...
<html lang="en">
  ...
  <!----------------------------------------------------------------------------------------------------------->
   ...
   <div class="search" style="display:flex;margin-left:300px ">
    <form class="form-inline" action="manageUsers.jsp" method="post">
        <div>
...
<div class="col-md-6">
                    <table class="styled-table">
                        <h3 class="CIFD">User information</h3>
...
<!--                                <th scope="col">Report count</th>-->
                        ...
                        <tbody>
                            ...
                            if (request.getParameter("search") != null) {
                                String search = request.getParameter("search");
                                    q="SELECT * FROM user WHERE username='"+search+"'";
                      ...
                      q="SELECT * FROM user";
                            ...
                            <tr>
                                ...
                                <td><a href='manageUserServlet?username=<%=rs.getString("username")%>'>Delete</a> </td>
                            </tr>
                            <%}%>
                        </tbody>
                    </table>
